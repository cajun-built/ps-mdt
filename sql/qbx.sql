...
CREATE TABLE IF NOT EXISTS `mdt_reports` (
  ...
  `owning_agency` varchar(16) DEFAULT NULL,
  `task_force_id` char(36) DEFAULT NULL,
  `lifecycle_status` enum('draft','submitted','approved','closed','voided') NOT NULL DEFAULT 'submitted',
...
CREATE TABLE IF NOT EXISTS `mdt_cases` (
  ...
  `owning_agency` varchar(16) DEFAULT NULL,
  `task_force_id` char(36) DEFAULT NULL,
  `lifecycle_status` enum('active','closed','voided') NOT NULL DEFAULT 'active',
  `version` int(10) unsigned NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `mdt_evidence_items` (
  ...
  `pending_holder` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transfer_requested_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `owning_agency` varchar(16) DEFAULT NULL,
  `task_force_id` char(36) DEFAULT NULL,
  `compartment` varchar(64) DEFAULT NULL,
  `lifecycle_status` enum('active','released','disposed','voided') NOT NULL DEFAULT 'active',
  `version` int(10) unsigned NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `mdt_evidence_custody` (
  ...
  `action` enum('collected','transferred','transfer_requested','transfer_accepted','transfer_declined','stored','released','disposed','updated','viewed') NOT NULL DEFAULT 'collected',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
